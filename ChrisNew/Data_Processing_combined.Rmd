---
title: "Data_Processing_combined"
author: "chris"
date: "11/10/2020"
...
plot(factor(train$country),train$duration,xlab = 'Country', ylab = 'Duration',main = '',las=2)
table(train$country)
plot(factor(train$sex),train$duration,xlab = 'Sex', ylab = 'Duration',main = '')
```
...
More data manipulation(From Tang Ao) and export train data
```{r}
